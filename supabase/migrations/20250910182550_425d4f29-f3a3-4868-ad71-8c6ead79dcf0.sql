...
-- Update feature pricing to be more granular and cost-effective
DELETE FROM public.feature_pricing;

INSERT INTO public.feature_pricing (feature, credits_per_unit, unit_description) VALUES
('voice_clone_training', 500, 'Initial voice clone training'),
('tts_generation', 1, 'Per 5 seconds of generated audio'),
('chat_interaction', 1, 'Per 750 tokens (~500 words)'),
('audio_transcription', 2, 'Per minute of audio transcription'),
('voice_personalization', 100, 'Voice personality adjustment'),
('memory_analysis', 5, 'Advanced memory processing');