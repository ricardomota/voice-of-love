...
-- Update voices_base table for ElevenLabs base voices (handle foreign key properly)
DELETE FROM public.voices_base;
...
('SAz9YHcvj6GT2YYXdXww', 'elevenlabs', 'neutral', ARRAY['pt-BR'], ARRAY['warm', 'conversational'], '{"model_id": "eleven_multilingual_v2", "voice_settings": {"stability": 0.5, "similarity_boost": 0.8}}'),
('TX3LPaxmHKxFdv7VOQHJ', 'elevenlabs', 'male', ARRAY['pt-BR'], ARRAY['mature', 'authoritative'], '{"model_id": "eleven_multilingual_v2", "voice_settings": {"stability": 0.6, "similarity_boost": 0.7}}'),
('XB0fDUnXU5powFXDhCwa', 'elevenlabs', 'female', ARRAY['es'], ARRAY['warm', 'conversational'], '{"model_id": "eleven_multilingual_v2", "voice_settings": {"stability": 0.5, "similarity_boost": 0.8}}'),
('onwK4e9ZLuTAKqWW03F9', 'elevenlabs', 'male', ARRAY['es'], ARRAY['mature', 'authoritative'], '{"model_id": "eleven_multilingual_v2", "voice_settings": {"stability": 0.6, "similarity_boost": 0.7}}');
