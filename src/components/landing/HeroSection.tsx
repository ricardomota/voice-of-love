  ...
  return (
    <>
      <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 pt-32 sm:pt-36 lg:pt-40 xl:pt-44 overflow-hidden">
        {/* Enhanced Background - Shifted Right */}
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-br from-primary via-primary/90 to-accent transform translate-x-8" />
          <div className="absolute inset-0 bg-gradient-to-t from-primary/20 via-transparent to-transparent transform translate-x-4" />

          {/* Grainy noise overlay */}
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute inset-0 hero-grainy-noise opacity-30 transform translate-x-6" />
          </div>
          
          {/* Animated Background Elements - Positioned Right */}
          <div className="absolute top-20 right-20 w-32 h-32 bg-secondary/15 rounded-full blur-3xl opacity-40 animate-float-slow" />
          <div className="absolute bottom-32 right-32 w-40 h-40 bg-accent/15 rounded-full blur-3xl opacity-30 animate-float-medium" />
          <div className="absolute top-1/3 right-1/4 w-64 h-64 bg-secondary/10 rounded-full blur-3xl opacity-50 animate-float-fast" />
          <div className="absolute top-3/4 right-1/3 w-24 h-24 bg-primary/20 rounded-full blur-2xl opacity-60 animate-bounce-slow" />
          
          {/* Animated Grid Pattern */}
          <div className="absolute inset-0 opacity-20 transform translate-x-4">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_1px_1px,rgba(255,255,255,0.15)_1px,transparent_0)] [background-size:50px_50px] animate-grid-drift" />
          </div>
        </div>
