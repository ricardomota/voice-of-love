...
export const BetaDisclaimer: React.FC = () => {
  ...
  return (
    <div className="flex justify-center py-8">
      <div className="inline-flex items-center gap-3 px-8 py-4 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-full shadow-sm">
